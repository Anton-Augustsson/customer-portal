...
public class Subscriber {
  ...
  */
  @NotNull 
  @Schema(name = "id", example = "311109", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public Long getId() {
    return id;
  }
  ...
  */
  @NotNull 
  @Schema(name = "username", example = "bob123", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  ...
  @Schema(name = "name", example = "bob smith", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
